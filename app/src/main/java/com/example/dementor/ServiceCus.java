...
public class ServiceCus extends Service {
...
//        windowManager.addView(view,params);
        ...
        ShakeDetector.create(this, () -> {
            ...
            if(!oldNumbers.isEmpty()){
                for(String ENUM : oldNumbers) {
                    manager.sendTextMessage(ENUM,null,"Device might have taken a Fall!\nCheck on Owner at Location :\n"+myLocation,null,null);
                }
            }
...
//                    windowManager.removeView(view);
            ...
            Intent notificationIntent = new Intent(this, SMS_Activity.class);
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                Notification notification = new Notification.Builder(this, "MYID")
                        .setContentTitle("AlterAssist")
                        .setContentText("Shake Device to Send SOS")
                        .setSmallIcon(R.drawable.oldies)
